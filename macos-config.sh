...
# The following line is trouble! If the script crashes,
# the "while true" loop will never stop!
...
# Configure automatic termination of inactive apps
...
# Configure automatic capitalization 
defaults write NSGlobalDomain NSAutomaticCapitalizationEnabled -bool false

# Configure smart dashes as they’re annoying when typing code
defaults write NSGlobalDomain NSAutomaticDashSubstitutionEnabled -bool false

# Configure automatic period substitution as it’s annoying when typing code
defaults write NSGlobalDomain NSAutomaticPeriodSubstitutionEnabled -bool false

# Configure smart quotes as they’re annoying when typing code
...
# Since Mojave, universalaccess is protected.
# Give access to the script to access the entire disk?
...
## -- https://forum.latenightsw.com/t/changing-universal-access-preferences/1923/5
...
# Configure “natural” (Lion-style) scrolling: true = "natural"
...
# This may require granting Terminal the privileges to change Accessibility settings
# Couldn't get it to work in Catalina
...
# Note that the "-init" switch doesn't seem to work in Catalina
# Default = 6
...
# systemsetup results in errors on Catalina
...
# Finder: configure window animations and Get Info animations 
...
# Adjust the auto-hiding Dock delay (default = 0.5)
defaults write com.apple.dock autohide-delay -float 0
# Adjust the animation when hiding/showing the Dock (default = 0.5)
...
# Check for software updates daily (1), or weekly (7)
defaults write com.apple.SoftwareUpdate ScheduleFrequency 7
...
# Configure automatic emoji substitution (false = use plain text smileys)
...
# Configure continuous spell checking
